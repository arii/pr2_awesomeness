...
class ControllerManager():
  ...
  #whicharm is 'r' or 'l'
  def __init__(self, whicharm, tf_listener = None, __=None, _=None): 
  ...
  def move_cartesian(self, goal_pose, collision_aware = 0, blocking = 1,
                     ...
                     timeout = rospy.Duration(5.), settling_time=rospy.Duration(1.), 
                     overshoot_dist=0.005, overshoot_angle=0.05, stuck_dist=0.005, stuck_angle=0.001):
